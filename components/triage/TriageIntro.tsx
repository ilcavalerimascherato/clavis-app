    ...
    <BgLayout centered>
      <div className="max-w-2xl w-full mx-auto space-y-10 text-center">
        ...
        <div className="border border-zinc-800 p-8 space-y-4">
          ...
          <p className="text-zinc-400 text-base">I tuoi dati non vengono condivisi con terzi.</p>
        ...
        <div className="grid grid-cols-3 gap-2 text-base">
          {[
            ...
            <div key={n.code} className="border border-zinc-800 p-3">
              ...
              <p className="text-zinc-500 mt-1 text-sm">{n.desc}</p>
            </div>
          ))}
        </div>

        <div className="border border-zinc-800 p-4 grid grid-cols-3 gap-4 text-center text-base text-zinc-400">
          <div>
            <p className="text-white text-2xl font-mono font-bold">22</p>
            <p className="mt-1">domande slider</p>
          </div>
          <div>
            <p className="text-white text-2xl font-mono font-bold">6</p>
            <p className="mt-1">sezioni tematiche</p>
          </div>
          <div>
            {/* aggiornato: 24 tipologie con SL */}
            <p className="text-white text-2xl font-mono font-bold">24</p>
            <p className="mt-1">tipologie struttura</p>
          </div>
        </div>
